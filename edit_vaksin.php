...
if( isset($_POST['update']) ){
    ...
    $next_vaksin   = $_POST['next_vaksin'];
    $jumlah_ayam   = $_POST['jumlah_ayam'];
    $biaya_vaksin   = $_POST['biaya_vaksin'];

    $query = "UPDATE vaksin_detail SET tanggal_vaksin='$tanggal_vaksin', jenis_vaksin='$jenis_vaksin', jumlah_ayam='$jumlah_ayam', next_vaksin='$next_vaksin', biaya_vaksin='$biaya_vaksin' WHERE id='$id'";
    echo $query;
